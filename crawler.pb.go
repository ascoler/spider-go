...
const file_crawler_proto_rawDesc = "" +
	"\n" +
	"\rcrawler.proto\x12\acrawler\x1a\x1fgoogle/protobuf/timestamp.proto\"\\\n" +
	"\x14StartCrawlingRequest\x12\x1b\n" +
	"\tseed_urls\x18\x01 \x03(\tR\bseedUrls\x12'\n" +
	"\x06config\x18\x02 \x01(\v2\x0f.crawler.ConfigR\x06config\"\x81\x01\n" +
	...
	"\x12GetDiscoveredLinks\x12\x18.crawler.GetLinksRequest\x1a\x19.crawler.GetLinksResponseB\vZ\t.;crawlerb\x06proto3"
